...
function loadBooks() {
  firebase.firestore().collection('books').onSnapshot(snap => {
    ...
    // Til o'zgartirilganda yoki boshqa funksiyalar chaqirilganda avtomatik ravishda asosiy sahifani tozalash
    // Shuningdek, qidiruv natijalarini tozalash uchun
    filterAndRenderBooks(); 
...
const transliterationMap = {
  ...
  "ʼ": "'", // Dastlabki ko'rinish uchun apostrof
  // Qo'shimcha belgilar
  "‘": "'", "’": "'", "“": "\"", "”": "\"",
};
